...
生成器的主要优点是简单。与实现 `Iterator` 类相比，编写更少的代码 ，并且代码通常更具可读性。

然而，这种灵活性需要付出代价：生成器只是仅向前迭代器，一旦迭代开始就无法倒回。这也意味着同一个生成器不能多次迭代：生成器需要通过再次调用生成器函数来重建，或者通过 `clone` 关键字克隆。
...
class Foo implements Iterator
{
    ...
    /**
     * Print the current line content of the specified property.
     *
     * @param  void
     * @return void
     */
    ...
    /**
     * Print the current line number of the specified property.
     *
     * @param  void
     * @return void
     */
    ...
    /**
     * Check the validity of the current position of the specified property.
     *
     * @param  void
     * @return bool
     */
