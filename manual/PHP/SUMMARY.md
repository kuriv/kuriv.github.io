...
* [PHP](README.md)
    * [语言参考](docs/语言参考.md)
        ...
        * [预定义接口](docs/语言参考/预定义接口.md)
            * [遍历](docs/语言参考/预定义接口/遍历.md)
            * [迭代器](docs/语言参考/预定义接口/迭代器.md)
            * [聚合式迭代器](docs/语言参考/预定义接口/聚合式迭代器.md)
            * [数组式访问](docs/语言参考/预定义接口/数组式访问.md)
            * [序列化](docs/语言参考/预定义接口/序列化.md)
            * [闭包类](docs/语言参考/预定义接口/闭包类.md)
            * [生成器](docs/语言参考/预定义接口/生成器.md)
