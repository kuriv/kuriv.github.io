...
$foo = ['10', 11, 100, 100, 'a'];
$bar = [1, 2, '2', 3, 1];
array_multisort($foo, SORT_REGULAR, $bar);
...
$foo = ['10', 11, 100, 100, 'a'];
$bar = [1, 2, '2', 3, 1];
array_multisort($foo, SORT_STRING, $bar);
...
$foo = ['10', 11, 100, 100, 'a'];
$bar = [1, 2, '2', 3, 1];
array_multisort($foo, SORT_LOCALE_STRING, $bar);
var_dump($foo); // array(5) { [0]=> string(2) "10" [1]=> int(100) [2]=> int(100) [3]=> int(11) [4]=> string(1) "a" }
var_dump($bar); // array(5) { [0]=> int(1) [1]=> string(1) "2" [2]=> int(3) [3]=> int(2) [4]=> int(1) }

$foo = ['10', 11, 100, 100, 'a'];
$bar = [1, 2, '2', 3, 1];
array_multisort($foo, SORT_NATURAL, $bar);
...
$foo = ['a' => 'Cat1', 'b' => 'cat2', 'c' => 'Cat3', 'd' => 'cat20'];
$bar = [2, 4, 5, 0];
array_multisort($foo, SORT_STRING | SORT_FLAG_CASE, $bar);
...
$foo = ['a' => 'Cat1', 'b' => 'cat2', 'c' => 'Cat3', 'd' => 'cat20'];
$bar = [2, 4, 5, 0];
array_multisort($foo, SORT_NATURAL | SORT_FLAG_CASE, $bar);
...
$foo = ['10', 11, 100, 100, 'a'];
$bar = [1, 2, '2', 3, 1];
array_multisort($foo, SORT_ASC, SORT_STRING, $bar, SORT_NUMERIC, SORT_DESC);
var_dump($foo); // array(5) { [0]=> string(2) "10" [1]=> int(100) [2]=> int(100) [3]=> int(11) [4]=> string(1) "a" }
...
extract(['foo' => 'cat', 'bar' => 'dog', 'baz' => 'bird']);
...
$bar = 'bar';
$baz = 'baz';
extract(['foo' => 'cat', 'bar' => 'dog', 'baz' => 'bird'], EXTR_OVERWRITE);
var_dump($foo);        // string(3) "cat"
var_dump($bar);        // string(3) "dog"
var_dump($baz);        // string(4) "bird"
...
$bar = 'bar';
$baz = 'baz';
extract(['foo' => 'cat', 'bar' => 'dog', 'baz' => 'bird'], EXTR_SKIP);
...
$bar = 'bar';
$baz = 'baz';
extract(['foo' => 'cat', 'bar' => 'dog', 'baz' => 'bird', 'qux' => 'horse'], EXTR_PREFIX_SAME, 'prefix');
...
$bar = 'bar';
$baz = 'baz';
extract(['foo' => 'cat', 'bar' => 'dog', 'baz' => 'bird', 'qux' => 'horse'], EXTR_PREFIX_ALL, 'prefix');
var_dump($prefix_foo); // string(3) "cat"
var_dump($prefix_bar); // string(3) "dog"
var_dump($prefix_baz); // string(4) "bird"
...
$bar = 'bar';
$baz = 'baz';
extract([0 => 'cat', 1 => 'dog', 'baz' => 'bird'], EXTR_PREFIX_INVALID, 'prefix');
...
$bar = 'bar';
$baz = 'baz';
extract(['foo' => 'cat', 'bar' => 'dog', 'baz' => 'bird', 'test' => 'horse'], EXTR_IF_EXISTS);
var_dump($foo);        // string(3) "cat"
var_dump($bar);        // string(3) "dog"
var_dump($baz);        // string(4) "bird"
...
$bar = 'bar';
$baz = 'baz';
extract(['foo' => 'cat', 'bar' => 'dog', 'baz' => 'bird', 'test' => 'horse'], EXTR_PREFIX_IF_EXISTS, 'prefix');
var_dump($prefix_foo); // string(3) "cat"
var_dump($prefix_bar); // string(3) "dog"
var_dump($prefix_baz); // string(4) "bird"
...
extract($array, EXTR_PREFIX_ALL | EXTR_REFS, 'prefix');
var_dump($prefix_foo); // string(3) "cat"
var_dump($prefix_bar); // string(3) "dog"
var_dump($prefix_baz); // string(4) "bird"
...
list('foo' => $foo, 'bar' => $bar, 'baz' => $baz) = ['foo' => 'foo', 'bar' => 'bar', 'baz' => 'baz'];
var_dump($foo); // string(3) "foo"
var_dump($bar); // string(3) "bar"
var_dump($baz); // string(3) "baz"
 ...
 * @return int
 */
function bar(array $a, array $b): int
{
...
$foo = [['cat'], ['dog'], ['bird']];
usort($foo, 'bar');
var_dump($foo); // array(3) { [0]=> array(1) { [0]=> string(4) "bird" } [1]=> array(1) { [0]=> string(3) "cat" } [2]=> array(1) { [0]=> string(3) "dog" } }
